$(function () {
    ...
    for (var i = 0; i < assess_session.attributes.length; i++) {
        ...
        var text_table =
            ...
            "</td>" +
            "<td>" +
            attribute.questionnaire.number +
            "</td>";
        ...
        for (var ii = 0, len = attribute.val_med.length; ii < len; ii++) {
            ...
            if (attribute.questionnaire.points[attribute.val_med[ii]]) {
                ...
                text_table +=
                    '<td><button type="button" class="btn btn-outline-dark btn-xs answer_quest" id="q_' +
                    attribute.name +
                    "_" +
        ...
        text_table +=
            "<tr><td>" +
            attribute.val_max +
            "</td><td> : </td><td>1</td></tr></table></td>";

        if (attribute.questionnaire.number === attribute.val_med.length) {
            text_table +=
                '<td><button type="button" class="btn btn-outline-dark btn-xs calc_util" id="u_' +
                attribute.name +
                '">Utility function</button></td>';
        } else {
